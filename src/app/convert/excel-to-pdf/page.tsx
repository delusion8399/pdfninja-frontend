...
export default function Page() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetch(`${config.apiBaseUrl}/pdf/convert/excel-to-pdf`, {
        method: "POST",
        body: formData,
      });
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transform -rotate-1 mb-12">
          ...
          <p className="text-xl text-black mb-6 max-w-3xl mx-auto leading-relaxed font-medium">
            Convert your Excel spreadsheets to PDF format with high quality and ease.
          </p>
        </div>
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              >
                ...
                <div className="text-center">
                  <p className="text-2xl font-bold mb-2 text-black">Drop your Excel spreadsheet here</p>
